export const translations = {
  en: {
    ...
    sidebarMain: "MAIN",
    sidebarMore: "MORE",
    // IA groups (Phase 5b: Story / Sense / Decide / Act / Support)
    groupStory: "Story",
    groupSense: "Sense",
    groupDecide: "Decide",
    groupAct: "Act",
    ...
    mtb_vision: "Vision",
    mtb_more: "More",
    mtb_drawer_title: "More views",
    mtb_drawer_close: "Close",
    // Unified state language
    stateLoading: "Loading",
    stateLoadingData: "Loading data...",
    stateEmpty: "Nothing here",
    stateEmptyTitle: "Nothing to show",
    stateEmptyDesc: "There's no data for this view yet. Try a different filter or check back later.",
    stateError: "Something went wrong",
    stateErrorTitle: "Couldn't load data",
    stateErrorRetry: "Try again",
    viewMonitor: "Monitor",
    viewHome: "Home",
  ...
  zh: {
    ...
    mtb_vision: "愿景",
    mtb_more: "更多",
    mtb_drawer_title: "更多视图",
    mtb_drawer_close: "关闭",
    // 状态语言统一
    stateLoading: "加载中",
    stateLoadingData: "加载数据中...",
    stateEmpty: "暂无内容",
    stateEmptyTitle: "暂无数据",
    stateEmptyDesc: "当前视图暂无数据，可换一个筛选条件或稍后再试。",
    stateError: "出错了",
    stateErrorTitle: "数据加载失败",
    stateErrorRetry: "重试",
    // Year slider milestones
